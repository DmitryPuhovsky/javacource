...
public class Operators {
    ...
    public static void main(String[] args) {
        ...
        trueRes2 |= returnTrue(); //Сокращенная запись, равная trueRes2 = trueRes2 | returnTrue();
        boolean falseRes2 = returnFalse() & returnTrue(); //Будут вызваны оба метода, несмотря на то, что слева false.
        falseRes2 &= returnTrue(); //Сокращенная запись, равная falseRes2 = falseRes2 & returnTrue();
